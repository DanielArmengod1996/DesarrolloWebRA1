<div class="container">
    ...
    <form enctype="multipart/form-data" action="updateVideo.php" method="post">
        <input name="idVideo" type="hidden" id="inputNombre" value="<?php echo $_REQUEST["id_video"] ?>" autofocus="">
